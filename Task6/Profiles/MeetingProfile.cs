...
public class MeetingMappingPforile : Profile
{
    public MeetingMappingPforile()
    {
        CreateMap<Meeting, MeetingDetail>()
            ...
            .ForMember(dest => dest.MeetingParticipants, opt => opt.MapFrom(src => src.MeetingParticipants.
                Select(mp => new ParticipantDto{Name = mp.Participant.Name, Id = mp.Participant.Id})));
